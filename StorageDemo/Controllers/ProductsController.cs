...
using StorageDemo.Models.ViewModels;

namespace StorageDemo.Controllers
{
    public class ProductsController : Controller
    {
        private readonly StorageDemoContext _context;

        public ProductsController(StorageDemoContext context)
        {
            _context = context;
        }
        ...
        {
            IEnumerable<ProductViewModel> model = await _context.Product
        ...
        public async Task<IActionResult> Category(string category)
        {
            ...
            return View(nameof(GetInventory),model);
        }
